      ...
      <div className="max-w-md w-full space-y-8 text-center">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground">
            You don&apos;t have permission to join this video consultation. This could be because:
          </p>

          <ul className="text-sm text-muted-foreground space-y-2 mt-4">
            <li>• The consultation was cancelled</li>
            <li>• The consultation time has passed</li>
            <li>• You&apos;re not authorized to join this consultation</li>
            <li>• The consultation link is invalid</li>
          </ul>
        </div>
